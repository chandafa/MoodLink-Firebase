...
import { ArrowLeft, UserPlus, MessageSquare, Edit, Flag, Trash2, MoreVertical, Bookmark, Vote, BookText, Globe, Lock, Users as UsersIcon, BadgeCheck, ShieldCheck, UserX, EyeOff } from 'lucide-react';
...
export default function PublicProfilePage({
  ...
  const handleTogglePrivacy = async () => {
    if (!userProfile) return;
    await toggleProfilePrivacy(userProfile.id, !userProfile.isPrivate);
  }
  ...
  const isProfileVisible = !userProfile.isPrivate || isAdmin;
        ...
        <Card>
            <CardHeader className="p-0">
               <div className="relative h-48 bg-secondary flex items-center justify-center rounded-t-lg">
                 {isProfileVisible && userProfile.bannerUrl && (
                    <Image
              ...
              <div className="pt-20 p-6 flex flex-col items-center">
                 ...
                 {isProfileVisible ? (
                    ...
                    <div className="mt-4 text-center">
                        ...
                        <p className="mt-2 font-semibold">Profil Ini Privat</p>
                        <p className="text-sm text-muted-foreground">Pengguna ini telah membatasi siapa saja yang dapat melihat profil dan aktivitas mereka.</p>
                    </div>
                 )}
              </div>
            </CardHeader>
                     ...
                     <AlertDialog>
                        <AlertDialogTrigger asChild>
                           <Button variant="secondary">
                                ...
                                {userProfile.isPrivate ? 'Jadikan Publik' : 'Jadikan Privat'}
                            </Button>
                        </AlertDialogTrigger>
                        <AlertDialogContent>
                            <AlertDialogHeader>
                                <AlertDialogTitle>Anda yakin ingin mengubah privasi profil ini?</AlertDialogTitle>
                                <AlertDialogDescription>
                                    Tindakan ini akan mengubah visibilitas profil dan postingan pengguna ini.
                                </AlertDialogDescription>
                            </AlertDialogHeader>
                            <AlertDialogFooter>
                                <AlertDialogCancel>Batal</AlertDialogCancel>
                                <AlertDialogAction onClick={handleTogglePrivacy}>Ya, Ubah</AlertDialogAction>
                            </AlertDialogFooter>
                        </AlertDialogContent>
                    </AlertDialog>
